...
namespace SmartNest.PlatformService.Functions;

/// <summary>
/// Shared helpers for thin HTTP Function triggers: current-user extraction, JSON body
/// reading, and exception-to-HTTP-status mapping. Mirrors
/// SmartNest.HomeService.Functions.HttpFunctionHelpers - kept as a project-local copy
/// (not promoted to SmartNest.Shared) since it depends on ASP.NET Core types not
/// referenced by the shared library.
/// </summary>
